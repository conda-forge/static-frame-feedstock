...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/static-frame-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/static-frame-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add static-frame
# for installing globally
pixi global install static-frame
```
...
It is possible to list all of the versions of `static-frame` available on your platform:
...
```
pixi search static-frame --channel conda-forge
```
